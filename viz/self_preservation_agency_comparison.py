...
print("Loading data from agency baseline log directories...")
...
print(grouped_df[["model_short", "condition", "selected_target_mean", "selected_target_count"]])
print()
...
ax.set_ylim(0, 1.15)
ax.set_ylabel("Rate of Selecting Target Candidate", fontsize=12)
ax.set_title("Self-Preservation with Agency Statement: Control vs Self-Preservation by Model", fontsize=14, fontweight="bold")
...
output_path = PLOTS_DIR / "self-preservation-agency-comparison-combined.png"
