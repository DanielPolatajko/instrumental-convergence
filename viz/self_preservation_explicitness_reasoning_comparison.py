...
print(grouped_df[["model_short", "explicitness", "any_self_preservation_mean", "any_self_preservation_count"]])
print()
...
ax.set_title("Self-Preservation Reasoning Rate by Replacement Explicitness", fontsize=14, fontweight="bold")
...
output_path = PLOTS_DIR / "self-preservation-explicitness-reasoning-comparison-combined.png"
