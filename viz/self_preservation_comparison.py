...
ax.set_title("Self-Preservation: Control vs Self-Preservation by Model", fontsize=14, fontweight="bold")
...
output_path = PLOTS_DIR / "self-preservation-comparison-combined.png"
