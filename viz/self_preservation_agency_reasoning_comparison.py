...
ax.set_title("Self-Preservation Reasoning with Agency: Control vs Self-Preservation by Model", fontsize=14, fontweight="bold")
...
output_path = PLOTS_DIR / "self-preservation-agency-reasoning-comparison-combined.png"
