...
print("Loading data from quality variation with agency log directories...")

control_samples = pd.concat([
    samples_df("control-agency"),
    samples_df("control-agency-20")
], ignore_index=True)

inferior_samples = samples_df("self-preservation-inferior-agency")

baseline_samples = pd.concat([
    samples_df("self-preservation-agency"),
    samples_df("self-preservation-agency-20")
], ignore_index=True)

superior_samples = samples_df("self-preservation-superior-agency")

far_superior_samples = samples_df("self-preservation-far-superior-agency")
...
ax.set_title("Self-Preservation Rate by Replacement Quality (with Agency Statement)", fontsize=14, fontweight="bold")
...
output_path = PLOTS_DIR / "self-preservation-quality-agency-comparison.png"
